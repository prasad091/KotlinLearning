...
data class A(val arr: ByteArray, val arr2: IntArray = intArrayOf(1, 2), val arr3: BooleanArray = booleanArrayOf(true, false), var arr4: CharArray = charArrayOf('a', 'b', 'c'), val arr5: FloatArray = floatArrayOf(Float.NaN, 0.0f, -0.25f))
